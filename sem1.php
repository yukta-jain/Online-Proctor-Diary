...
<body>
	...
	$sql="INSERT INTO sem1(usn,course_title,course_code, credits, re_register,attempt_no,faculty,attendance,cie_marks,see_grade,grade_points) VALUES ('$usn', '$ct','$cc','$cr','$reg','$an','$fc','$att','$cie','$see','$gp')";
	// echo $sql;
